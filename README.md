...
### Quick start
- **Download ParaRef** (masked & decontaminated genomes and taxonomic mapping files) from [Zenodo](https://doi.org/10.5281/zenodo.13744644) and unpack into ParaRef_PathopipeDB/fasta/.
- **Download Taxonomic mapping files** from [Zenodo](https://doi.org/10.5281/zenodo.21413835) and unpack into ParaRef_PathopipeDB/library/.
